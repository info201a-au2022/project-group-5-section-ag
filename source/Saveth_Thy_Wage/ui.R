                          ...
                          mainPanel(tableOutput("summary"),
                                    h3(
                                      ...
                                      h6(tags$ol(
                                        ...
                                        tags$li(" Only Netflix and Hulu out of all four Platforms have a show that holds a perfect rating. "),
                                        tags$li("Prime Video has the oldest average year of content while Netflix has the newest."), 
                                        tags$li("Netflix has the highest average show rating on Rottten Tomato while Prime Video has the lowest average show rating."),
